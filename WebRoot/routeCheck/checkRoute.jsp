...
<body>
	<div>
		<!-- 路线查询 -->
		<form action="routeCheckAction_check.action" method="post">
			<span style="color:#FF0000; font-size:18px; font-weight:bold">起始站：</span>
			<s:select name="directRouteViewId.beginStationId" list="stationList"
				headerKey="" headerValue="请选择起始站点" listKey="stationId"
				listValue="stationName" />
			&nbsp;&nbsp;&nbsp;&nbsp;
			<span style="color:#FF0000; font-size:18px; font-weight:bold">目标站点:</span>
			<s:select name="directRouteViewId.endStationId" list="stationList"
				headerKey="" headerValue="请选择目标站点" listKey="stationId"
				listValue="stationName" />
			&nbsp;&nbsp; <input type="submit" value="查询路线" style="color:#FF0000; font-size:18px;"/>
		</form>
		<br>
	</div>
